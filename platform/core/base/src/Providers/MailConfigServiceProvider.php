    ...
    public function boot(): void
    {
        $this->app->booted(function (): void {
            ...
            $this->app->resolving(MailManager::class, function () use ($config): void {
                ...
                $runtimeFallbackMailDriver = function_exists('proc_open') ? 'sendmail' : 'smtp';

                $defaultMailDriver = app()->environment('local')
                    ? $config->get('mail.default', $runtimeFallbackMailDriver)
                    : $runtimeFallbackMailDriver;
