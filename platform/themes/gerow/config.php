...
return [
    ...
    'events' => [
        'beforeRenderTheme' => function (Theme $theme): void {
            ...
            $theme->asset()->usePath()->add('custom-corporate-css', 'css/custom-corporate.css', version: $version);
            ...
            if (function_exists('shortcode')) {
                $theme->composer(['page', 'post', 'portfolio.service', 'portfolio.project', 'teams.team', 'templates.jorsas-landing'], function (View $view): void {
                    $view->withShortcodes();
                });
            }
